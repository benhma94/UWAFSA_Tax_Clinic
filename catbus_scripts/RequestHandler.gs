...
const REQUEST_TYPES = {
  HELP: {
    ...
    activeStatuses: [CONFIG.HELP_STATUS.ACTIVE, CONFIG.HELP_STATUS.ESCALATED, CONFIG.HELP_STATUS.IN_PROGRESS],
  ...
  REVIEW: {
    ...
    activeStatuses: [CONFIG.REVIEW_STATUS.REQUESTED, CONFIG.REVIEW_STATUS.IN_PROGRESS],
